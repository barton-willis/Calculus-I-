...
\vspace{-0.6in}
\begin{minipage}[c]{0.33333333333\textwidth}
\begin{align*}
...
\vspace{-0.5in}
\end{minipage}
\begin{minipage}[c]{0.3333333333333333\textwidth}
\section*{Limits}
\vspace{-0.4in}
\begin{align*}
...
\begin{align*}
    ...
    \sum_{k=0}^{n-1}{\left. {{k}^{2}}\right.} &=\frac{\left( n-1\right)  n\, \left( 2 n-1\right) }{6}\\
     \sum_{k=0}^{n-1}{\left. {{k}^{3}}\right.} &= \frac{{{\left( n-1\right) }^{2}}\, {{n}^{2}}}{4}\\
...
%\vspace{0.25in}
%\tiny
\noindent \textbf{Revised \today}. Barton Willis is the author of this work. This work is
