...
\begin{parts}
    ...
    \begin{solution}[1.5in]
     \begin{align*}
    \int (6 x + 3)(x+1) \, \mathrm{d} x &=  \int 6 x^2 + 9 x + 3 \, \mathrm{d} x,
                                             &\mbox{(expand)} \\
        &= 6 \int x^2 \, \mathrm{d} x + 9 \int x \, \mathrm{d} x + 3 \int 1\, \mathrm{d} x
                                              &\mbox{(linearity)} \\
        &= 6 \times \frac{1}{3} x^3 + 9 \times \frac{1}{2} x^2 + x + C,
                                              &\mbox{(power rule)} \\
        &= 2 x^3 + \frac{9}{2} x^2 + x + C.      &\mbox{(simplify)} 
   \end{align*}
   The fact $\int 1\, \mathrm{d} x = x + C$ is a special case of the power rule. But it's such a commonly 
   needed antiderivative, we should simply commit it to our long term memory.
    \end{solution}
    
    \part [1] $\int (x-1)(x+2) \, \mathrm{d} x = $
    \begin{solution}[1.5in]
    The process for this problem is much the same as before; my answer is
    \[
    ...
    \begin{align*}
    \int \frac{7}{x} + \frac{x}{7} \, \mathrm{d} x &=  7 \int \frac{1}{x} \, \mathrm{d} x + \frac{1}{7} \int x \, \mathrm{d} x
                                                                            &\mbox{(linearity)} \\
