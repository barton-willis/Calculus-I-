...
\begin{parts}
    ...
    \begin{solution}[1.5in]
      The integrand is a product. To use the additive property,
    ...
    simple that it can be checked without a pencil. Here is the check:
    \begin{equation*}
    ...
    \int \frac{7}{x} + \frac{x}{7} \, \mathrm{d} x 
      &= \int \frac{7}{x} \, \mathrm{d} x  + \int \frac{x}{7} \, \mathrm{d} x, &\mbox{(additity)} \\
...
%\newpage
    ...
    \begin{equation*}
      ...
      \int \cos(\uppi x)^2 \, \mathrm{d} x. 
    \end{equation*}
    To do this, we first match $x^n$ to   
